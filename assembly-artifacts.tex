...
% @CTB check & discuss: contig assembly only.
...
% @CTB note that the rumen genomes may not be correct -- later, in discussion.
...
% @CTB not primers; if systematic error, it's error prone.  not sure what
% to say.
% @CTB also reference 5' hexamer bias
...
% @CTB discuss length cutoff problem.
