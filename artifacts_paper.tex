...
\begin{figure}
\center{\includegraphics[width=5in]{./figures/lump_sizes.png}}
...
@Change this to % of kmers in reads (in, edge, out) vs. stoptags (in, edge, out) - bar graph with each percentage in different color with reads and stoptags side by side
